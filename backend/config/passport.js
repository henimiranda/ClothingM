...
if (!clientID || !clientSecret) {
  console.warn(
    'WARNING: Google OAuth credentials (GOOGLE_CLIENT_ID, GOOGLE_CLIENT_SECRET) are missing in environment variables!'
  );
}
...
passport.use(
  new GoogleStrategy(
    ...
    async (accessToken, refreshToken, profile, done) => {
      try {
        const ADMIN_EMAIL =
          process.env.ADMIN_EMAIL || 'henimiranda9@gmail.com';
